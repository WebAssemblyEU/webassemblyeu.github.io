...
})(["font-size:20px;color:rgba(255,255,255,0.75);border:1px solid rgba(255,255,255,0.5);background-color:rgba(255,255,255,0.05);border-radius:25px;padding:10px 5px;font-weight:bold;text-align:center;transition:150ms;&:hover{transform:scale(1.05);}"]);
...
//# sourceMappingURL=summit.js.0052b746ec38a2d9069e.hot-update.js.map