...
})(["font-size:20px;color:rgba(255,255,255,0.75);border:1px solid rgba(255,255,255,0.5);background-color:rgba(255,255,255,0.05);border-radius:25px;margin:5px;padding:10px 5px;font-weight:bold;text-align:center;transition:200ms;&:hover{transform:scale(1.1);}"]);
...
//# sourceMappingURL=summit.js.fa6d88c5439e11d35b75.hot-update.js.map