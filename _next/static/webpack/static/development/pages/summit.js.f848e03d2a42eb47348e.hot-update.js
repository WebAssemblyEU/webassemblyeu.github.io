...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  return __jsx(Centered, {
    ...
    __self: this
  }, __jsx(react_icons_fa__WEBPACK_IMPORTED_MODULE_3__["FaBell"], {
    style: {
      margin: "0 30px"
    },
    __source: {
...
})(["display:flex;align-items:center;justify-content:center;font-size:20px;color:rgba(255,255,255,0.75);border:1px solid rgba(255,255,255,0.5);background-color:rgba(255,255,255,0.05);border-radius:25px;padding:10px 0px;font-weight:bold;text-align:center;transition:150ms;&:hover{border:1px solid transparent;box-shadow:8px 8px 5px rgba(0,0,0,0.15);transform:scale(1.04);color:black;background-color:rgba(255,255,0,0.75);}"]);
...
//# sourceMappingURL=summit.js.f848e03d2a42eb47348e.hot-update.js.map