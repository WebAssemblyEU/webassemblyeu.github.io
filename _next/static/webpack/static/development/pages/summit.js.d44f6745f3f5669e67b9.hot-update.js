...
})(["display:flex;align-items:center;justify-content:stretch;font-size:20px;color:rgba(255,255,255,0.75);border:1px solid rgba(255,255,255,0.5);background-color:rgba(255,255,255,0.05);border-radius:25px;padding:10px 5px;font-weight:bold;text-align:center;transition:150ms;&:hover{border:1px solid transparent;box-shadow:8px 8px 5px rgba(0,0,0,0.05);transform:scale(1.04);color:black;background-color:rgba(255,255,0,0.75);}"]);
...
//# sourceMappingURL=summit.js.d44f6745f3f5669e67b9.hot-update.js.map